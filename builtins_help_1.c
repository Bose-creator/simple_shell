...
/**
 * help_all - To displays all the possible builtin shellby commands.
 */
void help_all(void)
{
...
/**
 * help_alias - To Displays information on shellby builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - To displays information on the shellby builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - To displays information on the shellby builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - To displays information on the shellby builtin command 'help'.
 */
void help_help(void)
{
