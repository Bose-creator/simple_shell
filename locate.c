...
/**
 * get_location - That Locates a command in the PATH.
 ...
 *
 * Return: The copy of path with any leading/sandwiched/trailing
...
/**
 * get_path_dir - That Tokenizes a colon-separated list of
